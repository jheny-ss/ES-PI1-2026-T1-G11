def registration_validation(registration_card):
    """
    Valida um título de eleitor verificando sua estrutura,
    tamanho e dígitos verificadores.

    Args:
        registration_card (str):
            Número do título de eleitor a ser validado.

    Returns:
        bool:
            True se o título de eleitor for válido.
